...
return [
    ...
    */
    ...
    'script_unique' => 'Скрипт с таким названием для выбранной страны уже существует',
    'customer_phone_unique' => 'Данный телефон указан основным для другого клиента',
    'payment_exceeded' => 'Превышена сумма оплаты',
